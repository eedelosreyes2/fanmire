...
<div class="container">
    ...
    <div class="create-post">
        ...
        <div class="posts-container">
            <div class="post" v-for="(post, index) in posts" v-bind:item="post" v-bind:index="index" v-bind:key="post.id" v-bind:tweet="post.tweet" v-on:dblclick="deletePost(post.id)">
                <p class="text">{{ post }}</p>
            </div>
        </div>
    </div>
